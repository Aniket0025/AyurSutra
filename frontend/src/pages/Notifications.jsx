...
export default function NotificationsPage() {
  ...
  const filteredNotifications = notifications.filter((n) => {
    ...
    if (activeTab === "alerts") return ["pre_therapy", "schedule_change"].includes(n.type);
    return true;
  });
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500">All your alerts and reminders in one place</p>
          </div>
        </div>
        <button
      ...
      <div className="space-y-4">
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-medium text-gray-500">No notifications here</h3>
